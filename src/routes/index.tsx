        ...
        <div className="grid md:grid-cols-5 gap-10 lg:gap-14 items-center">
          ...
          <div className="md:col-span-3">
            ...
            <p className="text-muted-foreground leading-relaxed mb-8">
              From slow-cooked biryanis to creamy rose pastas, every dish is hand-built from spices ground in-house and sauces that simmer for hours — never shortcuts, never compromises.
            </p>
